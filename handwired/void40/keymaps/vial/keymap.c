...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_ortho_4x12(
        ...
        KC_LCTL, MO(1),   KC_LGUI, KC_LBRC, KC_RBRC, KC_SPC,  KC_ENT,  KC_BSPC, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
    ),
    ...
    [1] = LAYOUT_ortho_4x12(
        ...
        KC_LSFT, KC_F10,  KC_F11,  KC_F12,  KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_COMM, KC_DOT,  KC_SLSH, KC_QUOT,
        KC_TRNS, MO(0),   KC_LGUI, KC_LBRC, KC_RBRC, KC_SPC,  KC_ENT,  KC_BSPC, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
    ),
